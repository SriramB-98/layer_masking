...
class InvertedResidual(nn.Module):
    ...
    def __init__(
        ...
        se_layer: Callable[..., nn.Module] = partial(SElayer, scale_activation=MyHardsigmoid),
    ):
        super().__init__()
        ...
        activation_layer = MyHardswish if cnf.use_hs else MyReLU
